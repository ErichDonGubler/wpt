...
const tests = [
  ...
  {
    name:
        '[expand] Test with the new shapes that are broadcastable and the number of new shapes larger than input.',
  ...
  {
    name:
        '[expand] Throw if the input shapes are not the same as new shape and not broadcastable.',
